...
// Public read-only viewer chrome: the Activity feed entry is removed, and the
// "Ask AI" control only renders when the optional chat panel is enabled
      ...
      >
        <div className="space-y-3">
          ...
          {MORE_ITEMS.map((item) => (
            ...
            >
              <span className="text-sm font-semibold text-shield">
                {item.label}
              </span>
              {item.note && (
                <span className="rounded-full bg-shield/8 px-2.5 py-1 text-xs font-medium text-shield/70">
