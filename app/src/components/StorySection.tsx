...
export default function StorySection({
  ...
  const isHandCraftedOrComposed =
    bioTier === 'hand_crafted' || bioTier === 'composed';
  ...
  if (isStructuredOnly) {
    ...
    return (
      <section className="bg-white/80 backdrop-blur-md rounded-2xl border border-white p-8 shadow-xl hover:shadow-2xl transition-shadow relative overflow-hidden group">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-oak/20 via-oak/40 to-oak/20"></div>
        <h2 className="text-sm font-bold text-shield uppercase tracking-widest mb-6 relative z-10">
          Story
        </h2>
    ...
    if (narrativeBio) {
      return (
        <section className="bg-white/80 backdrop-blur-md rounded-2xl border border-white p-8 shadow-xl hover:shadow-2xl transition-shadow relative overflow-hidden group">
          ...
          <div
            className="prose prose-gray max-w-none relative z-10
