...
export default function ContextMarker({ content: _content }: ContextMarkerProps) {
  ...
  return (
    <div className="flex items-center gap-2 py-2 opacity-30" aria-hidden="true" role="presentation">
