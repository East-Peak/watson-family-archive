...
export default function AISidebar({ overlay = false }: AISidebarProps) {
  ...
  const personId = isPersonPage
    ? (effectiveContext as { type: 'person'; personId?: string }).personId
    : undefined;
  const personName = isPersonPage
    ? (effectiveContext as { type: 'person'; personName?: string }).personName
    : undefined;
  ...
  const handleUndoVisualization = useCallback(
    (cmd: VisualizationCommand) => {
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-amber-200/40">
          <span className="text-sm font-serif font-medium text-shield">
            Family Historian
          </span>
          <button
            type="button"
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          <h2 className="font-serif font-medium text-shield text-sm">
            Family Historian
          </h2>
          <button
            type="button"
